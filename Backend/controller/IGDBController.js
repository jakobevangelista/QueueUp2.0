...
module.exports = (req,res) => {
    ...
    if (req.body.platform != "Not Specified" && req.body.multiplayer == false) {
    ...
    } else if (req.body.platform == "Not Specified" && req.body.multiplayer != false) {
    ...
    } else if (req.body.platform != "Not Specified" && req.body.multiplayer == true) {
        // all filters on
        options = {
        'method': 'POST',
        'url': 'https://api.igdb.com/v4/games/', // GAMES ENDPOINT
